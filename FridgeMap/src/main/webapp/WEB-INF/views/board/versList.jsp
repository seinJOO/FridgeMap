...
<div class="tile is-child box">
  ...
  <div class="tabs is-boxed">
    <ul>
      ...
      <li class="tab is-active"><a href="category?board_category=vers">자랑매치</a></li>
   ...
   <div class="list-item">
    ...
    <div class="list-item-controls edit">
      ...
      <c:if test="${list.user_id == sessionScope.user_id }"> <!-- 세션에 아이디 어떻게 저장했는지 확인하기 -->
        <button class="button" type="button" onclick="location.href='modify?board_category=${pageMaker.cri.board_category }&pageNum=${pageMaker.pageNum }&board_num=${list.board_num }'">
