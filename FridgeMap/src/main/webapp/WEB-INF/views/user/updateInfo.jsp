...
<div class="main">
   <section class="login-form">
      <h1>냉장고일지도</h1>
      <form action="updateInfoForm" method="post" id="updateInfoForm" name="updateInfoForm">  
       <div class="int-area2">
            <input type="text" class="check1" id="user_id" name="user_id" value="${vo.user_id }"
            autocomplete="off" readonly>
            <label for="user_id">ID</label>  
        	 </div>
         <div class="int-area2">
            <input type="text" class="check1" id="user_nick" name="user_nick" value="${vo.user_nick }"
                        autocomplete="off" readonly>
            <label for="user_nick">NICKNAME</label>
         </div>
         <div class="int-area">
            <input type="password" id="user_pw" name="user_pw" value="${vo.user_pw }"
            autocomplete="off">
            <label for="user_pw">PASSWORD</label>
         </div>
         <div class="int-area">
            <input type="password" id="user_pwCheck" name="user_pwCheck" value="${vo.user_pw }"
            autocomplete="off">
            <label for="user_pwCheck">PASSWORD CHECK</label>
         </div>
         <div class="int-area">
            <input type="email" id="user_email"  name="user_email"  value="${vo.user_email }"
            autocomplete="off">
